class CorrelationAccuracyNegMetric(tf.keras.metrics.Metric):
    def __init__(self, name='correlation_accuracy_neg', **kwargs):
        super(CorrelationAccuracyNegMetric, self).__init__(name=name, **kwargs)
